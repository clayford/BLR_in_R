...
Below we show how to visualize binary logistic regression models using the ggeffects and effects packages, both of which also calculate confidence intervals for predictions using the same method we just demonstrated. 
